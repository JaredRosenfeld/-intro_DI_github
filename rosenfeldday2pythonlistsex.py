...
for names1 in list_of_names:
    individual_names = input("Please enter your name: ")
    ages_of_names = int(input("Please enter your age: "))
    if individual_names == "Paul" and ages_of_names <= 16:
        list_of_names.remove(individual_names)
    elif individual_names == "George" and ages_of_names <= 16:
        list_of_names.remove(individual_names)
        continue
    elif individual_names == "John" and ages_of_names <= 16:
        list_of_names.remove(individual_names)
        continue
    elif individual_names == "Ringo" and ages_of_names <= 16:
        list_of_names.remove(individual_names)
    print(list_of_names)
# counter = 0
# list_of_names = ["Paul", "George", "John", "Ringo"]
...
#         individual_names = input("Please enter your name: ")
#         ages_of_names = int(input("Please enter your age: "))
#         while individual_names not in list_of_names:
#             if individual_names in list_of_names or ages_of_names > 16:
#                 continue
#             elif individual_names in list_of_names or ages_of_names < 16:
#                 continue
# list_of_names.remove(names1)
#
# print(list_of_names)
